...
!(function ($) {
  ...
  (function ($) {
    ...
    class i {
      constructor(i, s) {
        (this.element = i),
          ...
          (this.reactToMegamenuEnabled =
            "true" === $liquidMainHeader.attr("data-react-to-megamenu")),
          this.init();
      }
      init() {
      ...
      eventHandlers(t, e, i) {
        ...
        return (
          "click" === s
            ? (n.off(), n.on("click", this.handleToggle.bind(this, "toggle")))
            : ($(i).off(),
      ...
      handleToggle(t, e) {
        const { toggleType: i, handler: s } = this.options,
          n = undefined,
          o = $(e.currentTarget).closest("li"),
          a = o.children(".nav-item-children, .children"),
          l = o.hasClass("megamenu"),
          r = l && o.attr("data-bg-color"),
          d = l && o.attr("data-megamenu-bg-scheme");
        if (!a.length) return;
        e.preventDefault();
        ...
        "fade" === i &&
          ("show" === t
            ...
            : "hide" === t
            ? this.fadeOut(a, l)
            : "toggle" === t && this.fadeToggle(a, l, d, r)),
          "slide" === i &&
            ("show" === t
              ? this.slideDown(a, l, d, r)
              : "hide" === t
              ? this.slideUp(a, l)
              : "toggle" === t && this.slideToggle(a, l, d, r)),
          o
            .toggleClass(
          ...
          document.dispatchEvent(
            new CustomEvent("lqd-submenu-change", {
              bubbles: !1,
              detail: { state: h ? "show" : "hide", $submenu: a },
            })
          );
      }
      fadeToggle(t, e, i, s) {
        const { handler: n } = this.options,
          o = t.closest("li");
        "click" === n &&
          (t.css({
            visibility: "visible",
          ...
          this.reactToMegamenuEnabled &&
            ...
            this.$elementorHeaderWidgets &&
              ...
              this.$elementorHeaderWidgets.addClass(`lqd-active-row-${i}`))),
          $liquidMainHeader.toggleClass("megamenu-item-active", e),
          e &&
      ...
      fadeIn(t, e, i, s) {
        const { handler: n } = this.options,
          o = t.closest("li");
        "click" === n &&
          (t.css({ visibility: "visible", display: "none", opacity: 0 }),
          o
            .siblings()
            .find(".nav-item-children, .children")
            .stop()
            .fadeOut(this.options.animationSpeed),
          t.stop().fadeIn(this.options.animationSpeed)),
          e &&
            (this.reactToMegamenuEnabled &&
              (this.$elementorHeaderWidgets &&
                "transparent" !== i &&
              ...
              $liquidMainHeader.addClass(`megamenu-scheme-${i}`)),
      ...
      fadeOut(t, e) {
        ...
        "click" === i &&
          ...
          s
            ...
            .stop()
            .fadeOut(this.options.animationSpeed),
          t.stop().fadeOut(this.options.animationSpeed)),
          e &&
            (this.reactToMegamenuEnabled &&
              (this.$elementorHeaderWidgets &&
                this.$elementorHeaderWidgets.removeClass(
        ...
        t
          ...
          e &&
            (this.reactToMegamenuEnabled &&
              ...
              $liquidMainHeader.toggleClass(`megamenu-scheme-${i}`)),
      ...
      closeActiveSubmenu(t) {
        const { toggleType: e } = this.options;
        t.keyCode
          ? (this.$submenuParents.each((t, i) => {
              const s = $(i);
              s.removeClass("active, is-active"),
                this["fade" === e ? "fadeOut" : "slideUp"](
            ...
            document.dispatchEvent(
              new CustomEvent("lqd-submenu-change", {
                bubbles: !1,
                detail: { state: "hide", $submenu: null },
              })
            ))
          : this.$submenuParents.each(async (i, s) => {
              ...
              n.hasClass("is-active") &&
                (o.is(t.target) ||
                  ...
                  (n.removeClass("active, is-active"),
                  this["fade" === e ? "fadeOut" : "slideUp"](
        ...
        this.$submenuExpanders.attr("role", "button"),
          ...
          this.$submenuExpanders.each((t, e) => {
            const i = $(e),
              ...
              n = s.css("paddingTop"),
              o = undefined;
            "absolute" === i.css("position") &&
              i.css({ top: (s.height() + parseInt(n, 10)) / 2 - 18 }),
              i.insertAfter(s);
          }),
          this.$mobileNavCollapse
            .add(".nav-item-children", this.$mobileNavCollapse)
    ...
    class s {
      ...
      eventHandlers() {
        ...
        "hover" === t
          ...
          this.isBS5
            ? this.$targetElement.each((t, e) => {
                e.addEventListener("show.bs.collapse", this.onShow.bind(this)),
                  e.addEventListener(
                    "shown.bs.collapse",
    ...
    class n {
      constructor(t, e) {
        (this._defaults = s),
          ...
          (this.isOverlay = "absolute" === this.DOM.$element.css("position")),
  ...
  (function ($) {
    ...
    (t.prototype = {
      ...
      eventHandlers() {
        this.isBS5
          ? this.$contents.each((t, e) => {
              e.addEventListener("show.bs.collapse", this.onShow.bind(this)),
                e.addEventListener(
                  "shown.bs.collapse",
                  this.onShown.bind(this)
                ),
                e.addEventListener("hide.bs.collapse", this.onHide.bind(this));
            })
      ...
      destroy() {
        this.$contents.off(
          "show.bs.collapse shown.bs.collapse hide.bs.collapse"
        );
      },
    }),
      ($.fn[e] = function (i) {
        ...
        e.$element.addClass("items-loading"),
          $.ajax({
            ...
            success: function (t) {
              ...
              d.length ||
                (d = l.siblings(".ld-pf-nav-ajax").find("[data-ajaxify=true]"));
              let h = d.attr("href");
              const c = undefined;
              (h && parseInt(h.split("page/")[1].split("/")[0], 10)) <= o &&
                (h = n.replace(`page/${o}`, `page/${o + 1}`)),
                imagesLoaded(r.get(), function () {
                  if (
                    (h && n != h
                      ? e.$element.attr("href", h)
                      : (e.observer && e.observer.unobserve(e.element),
                        e.$element
                          .removeClass("items-loading")
                          .addClass("all-items-loaded")),
                    r.appendTo(s),
                    s.get(0).hasAttribute("data-liquid-masonry"))
                  ) {
    ...
    class i {
      ...
      playTitle(t) {
        const e = this.DOM.titles[this.prevSlide],
          ...
          s = this.isRTL
            ? e.querySelectorAll(".lqd-words")
            : e.querySelectorAll(".lqd-chars"),
          n = this.isRTL
            ? i.querySelectorAll(".lqd-words")
            : i.querySelectorAll(".lqd-chars"),
          o = gsap.timeline({
            defaults: { duration: 1 },
            delay: "next" === t ? 0.15 : 0,
          });
  ...
  (function ($) {
    ...
    (t.prototype = {
      ...
      doSomethingCrazyWithFilter() {
        ...
        if (!t) return !1;
        const { x: e, size: i } = this.flickityData,
          s = undefined,
          n = this.flickityData.cells.filter((t) =>
            $(t.element).is(":visible")
          )[0].size.width,
          o = gsap.utils.normalize(-n, 0, this.isRTL ? e + i.width : e),
          a = gsap.utils.mapRange(0, -n, 0, -100, this.isRTL ? e + i.width : e),
          l = gsap.utils.mapRange(0, -n, 0, -300, this.isRTL ? e + i.width : e);
          ...
          const s = new Promise((t) => {
            ...
            i.forEach((t) => {
              const s = getComputedStyle(t),
                { paddingLeft: n, paddingRight: o } = s;
              (e += t.offsetWidth + (parseInt(n, 10) + parseInt(o, 10))),
                1 === i.length && (t.style.width = "100%");
            }),
              t(e);
          });
          t.push(s);
        ...
        return (
          ...
          new Promise((t) => {
            new IntersectionObserver(([e], s) => {
              ...
              s.disconnect(),
                (i.width = e.target.offsetWidth),
                (i.height = e.target.offsetHeight),
                (i.top = n.top),
                (i.left = n.left),
                t(i);
      ...
      eventListeners() {
        document.addEventListener("lqd-submenu-change", (t) => {
          ...
          if (n?.length) {
            ...
            t >= 0
              ? "show" === i
                ? this.onMegamenuItemEnter(t)
                : this.onMegamenuItemLeave(t)
              : this.resetReveal();
  ...
  (function ($) {
    ...
    class i {
      ...
      initIO() {
        new IntersectionObserver(([t], e) => {
          t.isIntersecting &&
            (e.unobserve(t.target), this.$element.addClass("is-visible"));
  ...
  (function ($) {
    ...
    class o {
      ...
      performMovement(t) {
        ...
        }, 250 * parseFloat(this.options.scrollingSpeed))),
          (this.timeout1 = setTimeout(() => {
      ...
      isMoving() {
        ...
        return (
          ...
          this.scrollDelay + 250 * parseFloat(this.options.scrollingSpeed)
        );
      }
      hashChangeHandler() {
        var t,
      ...
      onLeave(t, e, i) {
        ...
        s.hasClass("main-footer") || o.hasClass("main-footer")
          ? s.hasClass("main-footer") &&
            o.removeClass("lqd-stack-row-entering lqd-stack-row-leaving")
  ...
  (function ($) {
    ...
    class i {
        ...
        (this._defaults = e),
          ...
          this.$activeItem.length &&
            ...
            (this.activeItemPosLeft = this.isRTL
              ? this.$tabNav.width() -
                -1 * (this.$activeItem.position().left + this.activeItemWidth)
      ...
      onShow(t) {
        const e = t.target,
          { deepLink: i, translateNav: s } = this.options,
  ...
  (function ($) {
    ...
    class i {
        ...
        (this._defaults = e),
          ...
          !this.DOM.items ||
            ...
            (this.onScrollerTransitionEnd =
              this.onScrollerTransitionEnd.bind(this)),
      ...
      onElementMouseWheel(t) {
        const { deltaY: e } = t.originalEvent;
        if (
          (e < 0
            ? ((this.isScrollingUp = !0), (this.isScrollingDown = !1))
            : e > 0 && ((this.isScrollingUp = !1), (this.isScrollingDown = !0)),
          ((0 === this.activeItem && this.isScrollingDown) ||
          ...
          this.isAnimating ||
            (this.isScrollingUp && this.activeItem > 0
              ? ((this.wheelFree = !1), this.navigate("prev"))
              : this.isScrollingDown &&
                this.activeItem !== this.DOM.items.length - 1 &&
                ((this.wheelFree = !1), this.navigate("next"))),
          !this.wheelFree || this.isAnimating)
        )
          return t.preventDefault(), !1;
      }
      onScrollerTransitionEnd(t) {
        t.target === this.DOM.scroller &&
          ((this.wheelFree = !0), (this.isAnimating = !1), this.navigateDone());
      }
      onElementMouseOver() {
        ((0 === this.activeItem && this.isScrollingDown) ||
          (this.activeItem === this.DOM.items.length - 1 &&
    ...
    class o {
      ...
      onClick(t) {
        ...
        if (s) {
          ...
          o = (
            liquidIsElementor
              ? t.nextAll(".elementor-section, .e-container, .e-con").first()
              : t.nextAll(".vc_row, .vc_section").first()
          ).offset().top;
        } else {
          const e = $(t.target).attr("href");
          if (!e || "" === e) return;
        ...
        t.preventDefault(),
          t.stopPropagation(),
          $liquidHtml.removeClass("overflow-hidden"),
          $("html, body").animate({ scrollTop: o - i - e }, n),
